window.onload = function() {
    document.getElementById('save').onclick = function() {
        ...
        var card = document.getElementById('cardNumber-input').value;
        var month = document.getElementById('cardExpiry-input').value;
        var year = document.getElementById('cardExpiry-input').value;
        var cvv = document.getElementById('cardCvc-input').value;
